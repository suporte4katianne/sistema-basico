...
import br.com.hsi.nfe.model.dados.Cep;
...
public class EmpresaFormularioBean implements Serializable {
	...
	public void salvar() throws IOException {
		...
		if(empresa.getNumeracao().size() == 0 || empresa.getNumeracao().isEmpty()){
			FacesUtil.addErrorMessage("Inclua uma sequecia de numeração para emitir NF-e");
		}else{
			...
			try {
				...
				empresa = new Empresa();
				FacesUtil.addInfoMessage("Emitente salvo com sucesso!");
